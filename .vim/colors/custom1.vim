...
hi Normal   cterm=none  ctermfg=252 ctermbg=233 gui=none    guifg=#d0d0d0   guibg=#202020
...
hi LineNr   cterm=none  ctermfg=238 ctermbg=16        gui=none    guifg=#a8a8a8
...
hi Comment  cterm=none  ctermfg=242 ctermbg=bg  gui=none    guifg=#808080   guibg=bg
""" COLD
hi Constant cterm=none  ctermfg=114 ctermbg=bg  gui=none    guifg=#dfdfaf   guibg=bg
""" COLD-DARK
...
""" WARM
hi Identifier   cterm=none  ctermfg=3 ctermbg=bg  gui=none    guifg=#afdf87   guibg=bg
